...
#python3 train_omni.py --train_path ../omniglot/python/images_background --test_path ../omniglot/python/images_validation --gpu_ids 0 --dropout_p 0.0 --dropout_n 0.0 --hloss_alpha 0.3 --model_path ../siamese_model_omni_new --is_hloss True 
